...
class BasicDBTest(unittest.TestCase):
    def setUp(self):
        ...
        'radio_measured_params': (1,1,1,'ivo://unknown:frb1','',790,3,17,9.4,0.2,0.2,0.3,'',None,None,0,2,0.01,-4.2,1.2,None,None,None,None,None,None,None,None,None,None,None,1),
