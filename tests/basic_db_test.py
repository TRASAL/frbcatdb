...
class BasicDBTest(unittest.TestCase):
    def setUp(self):
        ...
        'radio_observations_params': 'id,obs_id,author_id,settings_id,receiver,backend,beam,beam_semi_major_axis,beam_semi_minor_axis,beam_rotation_angle,raj,decj,gl,gb,pointing_error,sampling_time,bandwidth,centre_frequency,npol,channel_bandwidth,bits_per_sample,gain,tsys,mw_dm_limit,galactic_electron_model',
        ...
        'observations': (1,1,1,'type 1','telescope 1',datetime.datetime(2001, 1, 24, 23, 29, 14),'http://data111/',1,1),
        'observations_have_publications': (1,1),
        'observations_notes': (1,4,datetime.datetime(2016, 3, 13, 5, 45, 12),'J. Doe','some note'),
        'radio_observations_params': (1,1,1,'settings1','receiver 1','backend 1','beam 1',None,None,None,'19:06:53','-40:37:14',356.641,-20.0206,11,0.125,288,1372.5,2,None,1,0.69,28,110,None),
        ...
        'radio_measured_params': (1,1,1,'ivo://unknown:frb1',790,3,17,9.4,0.2,0.2,0.3,'',None,None,0,2,0.01,-4.2,1.2,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,1),
