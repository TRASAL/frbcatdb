...
class BasicDBTest(unittest.TestCase):
    def setUp(self):
        ...
        'radio_observations_params': (1,1,1,'settings1','receiver 1','backend 1','beam 1','19:06:53','-40:37:14',356.641,-20.0206,11,0.125,288,1372.5,2,None,1,0.69,28,110,7.5,7.5,0),
